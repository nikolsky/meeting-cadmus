...
os.environ['OPENAI_API_KEY'] = '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'
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = "my-project-98575-371210-114ac428d015.json"
...
def upload_file():
    if request.method == 'POST':
        ...
        #save_translated_txt(translated_txt, translated_text_path)
